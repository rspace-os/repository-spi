...
/**
 * Default do-nothing implementation useful for test environments or test
 * servers when there is no 'real' data repository to connect to.
 * 
 * @author radams
 * 
 */
public class StubRepositoryImpl implements IRepository {
	...
	public RepositoryOperationResult submitDeposit(IDepositor depositor, File toDeposit, SubmissionMetadata metadata,
		...
		log.info("Dummy Repository datafile " + toDeposit.getName() + "submitted by user " + depositor.getUniqueName());
