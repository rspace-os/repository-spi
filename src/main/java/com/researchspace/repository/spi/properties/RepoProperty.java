...
public abstract class RepoProperty {
	/**
	 * A readable, but unique name for this property within the set of required
	 * properties
	 */
	private String name;
	...
	/**
	 * Default value, or for ListRepoProperty a list of available choices to be
	...
	private void throwUnsupported(String type) {
		throw new UnsupportedOperationException(String
				.format("This class does not support conversion to a %s for value [%s]", type, getPossibleValue()));
	}
